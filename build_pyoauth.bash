#!/bin/bash
#  Download and install python oauth module
...
ARCHIVE_LOCATION=http://pypi.python.org/packages/source/${BUILD_TAG:0:1}/${BUILD_TAG}/${ARCHIVE}
...
echo "${TAG} Downloading ${ARCHIVE} in ${BUILD_DIR}"
